        ...
        <div class="container">
            ...
            <b-tabs content-class="mt-3">
                ...
                <b-tab title="Recebimento" active>
                    ...
                    <div class="row">
                        <div class="col-3">
                            <button id="button-save" @click="salvarRecebimento()" class="btn btn-primary">Criar</button>
                        </div>
                    </div>
...
export default {
    ...
    methods:{
        listarParcela(){
            Parcela.listarPorId(this.$router.currentRoute.params.id).then(res => {
        ...
        salvarRecebimento(){
            if(this.$v.$invalid == true) {
                ...
                Recebimento.salvar(this.recebimento).then(res => {
                    this.res = res
                    this.recebimento = {}
                    this.errors = []
...
<style scoped>
    ...
    #button-gerar-parcelas{
        background-color: var(--color-background-buttons-yellow);
        border: none;
        margin-bottom: 30px;
    }
